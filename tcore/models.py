...
class Setting(models.Model):
     ...
     phone_fixed=models.CharField(max_length=10,verbose_name=_('Sabit Telefon'))
     phone_mobile=models.CharField(max_length=10,verbose_name=_('Cep Telefonu'))
     ...
     twitter_url=models.URLField(max_length=255,verbose_name=_('X Adresi'))
